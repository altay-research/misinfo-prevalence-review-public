...
on 2026-09-21, freeze **v1.7.23** (1048 estimates from 443 studies), MD5 `08f050baf45086f45b5b3bec2390a115`.
...
This was verified on a fresh clone of the repository (2026-09-21): the three commands above run to
...
The paper: Altay, S. (2026). *Rare on screens but on everyone's mind: a systematic review of misinformation prevalence, exposure, and concentration.* Preprint: https://osf.io/preprints/psyarxiv/sgvr8
